...
| 版权信息 | ≤10 汉字 | **必须直接填写版权归属主体的名称**（设计师/工作室真实姓名或名称），**严禁填"无"、留空或填"暂无"——填"无"必被驳回** |
| 表情含义词 | ≤4 汉字/张 | 普通话，不含标点，同套不重复 |
| 赞赏引导语（可选） | 5～15 汉字 | 诙谐幽默，引导用户赞赏 |

> ⚠️ 文案尽量使用中文，方言需用汉字音译；**禁止使用表情符号和特殊字符**。

### 4.1 肖像权授权材料（含真人/未成年人形象时必交）

投稿含有真人肖像的作品（人像照片、肖像画、卡通肖像等），上传表情时须勾选**"涉及肖像权授权"**，并按以下要求提供材料：

**图中人物为未成年人（必交，缺一将被驳回）：**

1. 监护人身份证明 + 监护人与图中人物**关系证明**（户口簿照片、出生证明照片等）
2. 监护人与图中人物的**合照**
3. 若提交者**不是监护人**：还需提供**肖像权授权书**（授权人为监护人，被授权人为表情开放平台账号注册者）

**图中人物为成年人（非账号注册者本人时）：**

- 提供肖像权授权书（授权人为本人，被授权人为账号注册者）

**注**：账号注册者上传本人肖像作品，一般无需额外授权材料，但仍需如实勾选肖像权相关选项。

### 4.2 整套风格统一性（审核驳回高发项）

- **同一专辑的表情主图必须全部为同一风格**：使用写实照片制作的表情图与卡通绘制的表情图**严禁混合**在同一专辑
- **表情封面图、聊天面板图标、详情页横幅的风格必须与主图一致**（同为卡通或同为写实）
- 建议生成时在提示词中加入"风格统一性硬约束"：24 格逐格风格一致（统一线宽、上色方式、光影处理），生成后逐格比对第 1 格
- 表情图内文字标注须完整：**裁切为 240×240 正方形后文字不得残缺**，生成时文字应水平居中于格子中央 80% 安全区、不贴边、不跨格线
...
- [ ] **整套统一为卡通绘制或写实照片其中一种，严禁混用**；封面/图标/横幅风格与主图一致
- [ ] **每张图内文字完整展示**：无缺字、无半截字、无贴边被裁的文字
...
- [ ] 表情名称 ≤8 汉字，无标点空格
- [ ] 表情介绍 ≤80 汉字
- [ ] 版权信息 ≤10 汉字，**填写版权归属主体名称，未填"无"或留空**
- [ ] 每张表情含义词 ≤4 汉字，**使用普通话**，同套不重复

**肖像授权（含真人/未成年人形象时）**
- [ ] 已勾选"涉及肖像权授权"
- [ ] 未成年人：监护人身份证明 + 关系证明（户口簿/出生证明）+ 监护人与本人合照已备齐
- [ ] 提交者非监护人/非本人：肖像权授权书已备齐（授权人为监护人或本人，被授权人为账号注册者）
